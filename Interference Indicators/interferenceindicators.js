...
// --- RESTAURARE CALIBRARE DIN LOCALSTORAGE ---
...
// --- SALVARE CALIBRARE IN LOCALSTORAGE ---
...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  restoreCalibration(); // restauram calibrarile salvate
  ...
  function render(){
    ...
    // Bara WAM - inversat cu autocalibrare
    let wamRatio = 0;
    if(maxWAM > minWAM){
    ...
    // Bara USN - inversat cu autocalibrare
    let unRatio = 0;
    if(maxUN > minUN){
      ...
      try{
        ...
        if(data.sigRaw){
          ...
          if(vals.length>=2){
            ...
            // salvam calibrarea la fiecare update
